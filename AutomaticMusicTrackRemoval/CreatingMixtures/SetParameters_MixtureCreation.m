...
SOUNDTRACK_FILE = './AudioFiles/AvenidaBrasil/faixa10_mono_48000.wav';              % Soundtrack File
...
filterSoundtrack_bool = false;                    % 'false' to ignore filtering process and 'true' to use filter
