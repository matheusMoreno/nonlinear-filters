...
% your desired phon level. The frequencies evaulated in
% this function only span from 20Hz - 12.5kHz, and only 29
% selective frequencies are covered. This is the limitation
% of the ISO standard.
%
...
%%%%%%%%%%%%% TABLES FROM ISO226 %%%%%%%%%%%%%
% \---------------------------------------/
f = [20 25 31.5 40 50 63 80 100 125 160 200 250 315 400 500 630 ...
...
Tf = [ 78.5 68.7 59.5 51.1 44.0 37.5 31.5 26.5 22.1 ...
...
if((phon < 0) | (phon > 90))
    ...
    %Deriving sound pressure level from loudness level (iso226
    %sect 4.1)
